...
while ($true) {
    ...
    # Execute the command on the remote server using Invoke-Command
    Invoke-Command -ComputerName $remoteServer -Credential $cred -ScriptBlock $scriptBlock -ArgumentList $policyType
